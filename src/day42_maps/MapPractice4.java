...
public class MapPractice4 {
    public static void main(String[] args) {
        ...
        //This is Map of MapValue can be Map
        ...
        // usually you will not use something like this both key and value to be a map
        // only know it can also contain other map objects as for key or as for values or as for keys and values
        ...
        // map supports any non-primitive always supported
