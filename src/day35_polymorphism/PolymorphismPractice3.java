...
public class PolymorphismPractice3 {
    public static void main(String[] args) {
        ...
        System.out.println("================================================");
        //2. How many developers, testers, drivers do we have?
        ...
        System.out.println("numberOfDeveloper = " + numberOfDeveloper);
        System.out.println("numberOfTester = " + numberOfTester);
        System.out.println("numberOfTeachers = " + numberOfTeachers);
        System.out.println("numberOfDrivers = " + numberOfDrivers);

        System.out.println("===============================");

        //6. Display the names of employees who are not developers
        System.out.println("Names of employees who are not developers are: ");
        for (Employee each : employees) {
