...
public class TestStudentObjects {
    public static void main(String[] args) {
        ...
        Student[] students = {student2, student3, student4,student5};// one way add student to ArrayList

        StudentsGroup group1 = new StudentsGroup("Java Turtles", 1);
        group1.addStudent(student1); // the other way add student to ArrayList
